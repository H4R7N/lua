...
local LibName = "PetSimXH4R7NHub"

function Kavo:ToggleUI()
    if game.CoreGui.RobloxGui[LibName].Enabled then
        game.CoreGui.RobloxGui[LibName].Enabled = false
    else
        game.CoreGui.RobloxGui[LibName].Enabled = true
    end
end
